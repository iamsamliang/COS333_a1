# COS 333 Assignment 1: Assignment 1: A Registrar Application Using Database Programming
...
def main(argv):
    ...
    parser.add_argument(
        "-d", type=str, metavar="dept", help="show only those classes whose department contains dept")
    parser.add_argument(
        "-n", type=str, metavar="num", help="show only those classes whose course number contains num")
    parser.add_argument(
        "-a", type=str, metavar="area", help="show only those classes whose distrib area contains area")
    parser.add_argument(
        "-t", type=str, metavar="title", help="show only those classes whose course title contains title")
